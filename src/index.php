...
<div class="container">
    <!-- Content here -->
    <div class="row">
        <div class="col-sm-12 col-md-6 offset-md-3 mt-5 mb-3 text-center">

            <img src="assets/images/nws-math-game-logo.png" alt="Math Game" class="img img-fluid">


            <div class="col-12 mb-3">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="/easy" class="btn btn-outline-<?php if($_SESSION['game_difficulty'] == 'easy') {echo 'primary';} else {echo 'secondary';}?>">Easy</a>
                    <a href="/normal" class="btn btn-outline-<?php if($_SESSION['game_difficulty'] == 'normal') {echo 'primary';} else {echo 'secondary';}?>">Normal</a>
                    <a href="/medium" class="btn btn-outline-<?php if($_SESSION['game_difficulty'] == 'medium') {echo 'primary';} else {echo 'secondary';}?>">Medium</a>
                    <a href="/hard" class="btn btn-outline-<?php if($_SESSION['game_difficulty'] == 'hard') {echo 'primary';} else {echo 'secondary';}?>">Hard</a>
                    <a href="/ultra_hard" class="btn btn-outline-<?php if($_SESSION['game_difficulty'] == 'ultra_hard') {echo 'primary';} else {echo 'secondary';}?>">Ultra Hard</a>
                </div>
            </div>
            ...
            <p class="fs-4 text-primary mb-3">There is no score or prize... <br>Just you and a simple math question...
            </p>
